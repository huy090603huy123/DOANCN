...
Future<bool> checkLogin(String user, String password) async {
  var url = Uri.parse("${ip}/localconnect/login.php");
...
Future<bool> checkRegister(
  ...
  var url = Uri.parse("${ip}/localconnect/register.php");
  var response = await http.post(url, body: {
    "username": user,
    "password": password,
  });
...
Future<List<Account>> getDataAccount() async {
  var url = Uri.parse("${ip}/localconnect/account.php");
...
Future<bool> deleteDataAccount(String id) async {
  var url = Uri.parse("${ip}/localconnect/deleteAccount.php");
  var response = await http.post(url, body: {
    "ID": id,
  });
  //var data = json.decode(response.body);
...
Future<int> getoneAccount() async {
  var url = Uri.parse("${ip}/localconnect/loadaAccount.php");
  var response = await http.post(url, body: {
...
Future<List<Quiz>> getDataQuiz(String qTopic) async {
  var url = Uri.parse("${ip}/localconnect/loadquiz.php");
  var response = await http.post(url, body: {
    "qTopic": qTopic,
  });
  var data = response.body;
...
Future<void> updateScore(int score) async {
  var url = Uri.parse("${ip}/localconnect/updateScore.php");
  var response = await http.post(url, body: {
    "username": accountCurrent,
    "score": "${score}",
  });
...
Future<void> saveWord(String word, String? definition, String? vietnam,
  ...
  var url = Uri.parse("${ip}/localconnect/savenewwords.php");
  var response = await http.post(url, body: {
    "id": "${idCurrent}",
    "word": word,
...
Future<List<NewWord>> getDataNewWords() async {
  var url = Uri.parse("${ip}/localconnect/loadnewwords.php");
  var response = await http.post(url, body: {
    "id": "${idCurrent}",
  });
  //var data = json.decode(response.body);
...
Future<void> addQuiz(String content, String topic, String answer, String a,
  ...
  var url = Uri.parse("${ip}/localconnect/addQuiz.php");
  var response = await http.post(url, body: {
    "topic": topic,
    "content": content,
    "answer": answer,
...
Future<void> resetRank() async {
  var url = Uri.parse("${ip}/localconnect/resetRank.php");
  var response = await http.post(url, body: {});
  //var data = json.decode(response.body);
}

Future<List<WordLearn>> getDataWordLearn(String topic) async {
  var url = Uri.parse("${ip}/localconnect/loadwordlearn.php");
  var response = await http.post(url, body: {
    "topic": "${topic}",
  });
  //var data = json.decode(response.body);
...
Future<void> updateAccount(String id, String username, String passWord) async {
  var url = Uri.parse("${ip}/localconnect/updateAccount.php");
  var response = await http.post(url, body: {
    "username": username,
    "passWord": passWord,
    "id": id,
